...
.. important:: Обратите внимание, что мобильное приложение поддерживает устройства только с операционной системой Android версии не ниже 6.0.
...
#. Новая архитектура приложения, чтобы проще добавлять новые возможности и упростить разработку;
#. Отображение заряда батареи в процентах;
#. Добавили индикацию со статусом текущего состояния;
#. Возможность запускать/останавливать lua-script в режиме program;
...
#. Событие автопилота takeoff не приводит теперь к посадке коптера;
...
Также необходимо произвести обновление ПО квадрокоптера, скачать можно по ссылке: https://disk.yandex.ru/d/jxrQLED38ek2Rw?w=1
